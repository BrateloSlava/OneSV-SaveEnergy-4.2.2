...
static struct l2_level l2_freq_tbl_8960_kraitv1[] = {
	[0]  = { {STBY_KHZ, QSB,   0, 0, 0x00 },  950000, 1050000, 0 },
#ifdef CONFIG_LOW_CPUCLOCKS
	[1]  = { {  378000, HFPLL, 2, 0, 0x1C },  950000, 1050000, 1 },
	[2]  = { {  384000, PLL_8, 0, 2, 0x00 },  950000, 1050000, 1 },
	...
	[12] = { {  918000, HFPLL, 1, 0, 0x22 }, 1150000, 1150000, 5 },
	[13] = { {  972000, HFPLL, 1, 0, 0x24 }, 1150000, 1150000, 5 },
	[14] = { { 1026000, HFPLL, 1, 0, 0x26 }, 1150000, 1150000, 5 },
	[15] = { { 1080000, HFPLL, 1, 0, 0x28 }, 1150000, 1150000, 5 },
	[16] = { { 1134000, HFPLL, 1, 0, 0x2A }, 1150000, 1150000, 5 },
	[17] = { { 1188000, HFPLL, 1, 0, 0x2C }, 1150000, 1150000, 5 },
#else
...
static struct l2_level l2_freq_tbl_8930[] = {
	...
	[12] = { {  918000, HFPLL, 1, 0, 0x22 }, LVL_HIGH, 1150000, 5 },
	[13] = { {  972000, HFPLL, 1, 0, 0x24 }, LVL_HIGH, 1150000, 5 },
	[14] = { { 1026000, HFPLL, 1, 0, 0x26 }, LVL_HIGH, 1150000, 5 },
	[15] = { { 1080000, HFPLL, 1, 0, 0x28 }, LVL_HIGH, 1150000, 5 },
	[16] = { { 1134000, HFPLL, 1, 0, 0x2A }, LVL_HIGH, 1150000, 5 },
	[17] = { { 1188000, HFPLL, 1, 0, 0x2C }, LVL_HIGH, 1150000, 5 },
#else
...
static struct acpu_level acpu_freq_tbl_8930_fast[] = {
	...
	{ 1, {   270000, HFPLL, 2, 0, 0x14 }, L2(0),   800000 },
	{ 1, {   324000, HFPLL, 2, 0, 0x18 }, L2(0),   800000 },
	{ 1, {   378000, HFPLL, 2, 0, 0x1C }, L2(0),   800000 },
...
static struct l2_level l2_freq_tbl_8627[] = {
	...
	[10] = { {  810000, HFPLL, 1, 0, 0x1E }, LVL_HIGH, 1150000, 4 },
	[11] = { {  864000, HFPLL, 1, 0, 0x20 }, LVL_HIGH, 1150000, 4 },
	[12] = { {  918000, HFPLL, 1, 0, 0x22 }, LVL_HIGH, 1150000, 4 },
	[13] = { {  972000, HFPLL, 1, 0, 0x24 }, LVL_HIGH, 1150000, 4 },
#else
	[1]  = { {  384000, PLL_8, 0, 2, 0x00 },  LVL_NOM, 1050000, 1 },
	[2]  = { {  432000, HFPLL, 2, 0, 0x20 },  LVL_NOM, 1050000, 2 },
	[3]  = { {  486000, HFPLL, 2, 0, 0x24 },  LVL_NOM, 1050000, 2 },
